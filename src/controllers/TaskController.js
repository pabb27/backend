...
function store(req, res) {
  ...
  req.getConnection((err, conn) => {
    conn.query('INSERT INTO tasks SET ?', [data], (err, rows) => { /* crea un nuevo registro de tareas */
      res.redirect('/tasks'); /* una vez agregado el registro, redirecciona la pagina a la consulta de tareas */
    });
  });
}
